...
## Setup & Usage
1. Download the latest compiled version from the **Releases** section on GitHub.
2. Launch `QLAD_Midi_Learner.exe`.
3. Open the **≡ Options Panel** to select your MIDI input/output devices.
4. Load any standard `.mid` file and press **START** to begin.
